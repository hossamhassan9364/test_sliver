...
class _HomePage2State extends State<HomePage2> {
  ...
  final String description =
      'This text can be short or long. It affects the fin t can be short or long. It affects the fint can be short or long. It affects the final height.nt can be short or long. It affects the fin t can be short or long. It affects the fin t can be short or long. It affects the fin t can be short or long. It affects the fin ';
